...
try:
    ...
    # Shell-Skript ausführen
        ...
        if verbose != 1: print(colored("JSON wurde geuploaded!", 'green', attrs=['bold']))
    ...
    if verbose != 1: print(colored("Info: Output in vertretung.json gespeichert.", 'yellow', attrs=['bold']))
